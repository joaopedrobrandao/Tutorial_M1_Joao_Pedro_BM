...
var status = 1 #Variavel que dertermina se o jogo está rodando ou se o jogo parou
var vscore = 0 #Variavel que determina a pontuação do jogador 
var x = 2.0 #Variavel que determina a velocidade que o cenário se move para trás
var y = 2.0 #Variável que determina a velocidade de queda do dragão
